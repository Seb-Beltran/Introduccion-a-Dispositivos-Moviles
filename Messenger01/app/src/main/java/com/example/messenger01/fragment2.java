...
public class fragment2 extends Fragment {
    ...
    public void cargarLista2 () {
        ...
        listapersona2.add(new Persona2("Jose Fuentes", R.drawable.per1));
        listapersona2.add(new Persona2("Suri Monserat Rojas", R.drawable.per2));
        listapersona2.add(new Persona2("Victor CB", R.drawable.per3));
        listapersona2.add(new Persona2("Sinue Palacios", R.drawable.per4));
        listapersona2.add(new Persona2("Uriel Alarcon", R.drawable.per5));
        listapersona2.add(new Persona2("El michi del bigote", R.drawable.per6));
    }
